...
public class TestFetcher {
    ...
    final static Path testdir = new Path("D:/gitwork/nutch-release-1.10/build/test/fetch-test");
    Configuration conf;
    FileSystem fs;
    Path crawldbPath;
    Path segmentsPath;
    ...
    public void testFetch() throws IOException {
        ...
        Path[] generatedSegment =
                g.generate(crawldbPath, segmentsPath, 1, Long.MAX_VALUE, Long.MAX_VALUE, false, false);
    ...
    public void testAgentNameCheck() {
        ...
        try {
            ...
            failedNoAgentName =
                    message.equals("Fetcher: No agents listed in " + "'http.agent.name' property.");
        }
        catch (Exception e) {
        }
