...
public class TestGenerator {
    ...
    final static Path testdir = new Path("D:/gitwork/nutch-release-1.10/build/test/generator-test");
    ...
    public void testGenerateHostLimit() throws Exception {
        ...
        for (URLCrawlDatum datum : fetchList) {
            System.out.println(datum);
        }
    ...
    private Path generateFetchlist(int numResults, Configuration config, boolean filter) throws IOException {
        ...
        Path[] generatedSegment =
                g.generate(dbDir, segmentsDir, -1, numResults, Long.MAX_VALUE, filter, false);
